            ...
            try:
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        Name = line.getContact(op.param2)
                        if Name in RfuCctv['sidermem'][op.param1]:
                            pass
                        else:
                            RfuCctv['sidermem'][op.param1] += "\n👉" + Name
                            pref=['เพิ่มเลียนแบบ ','เพิ่มเลียนแบบ @!','เพิ่มเลียนแบบ @','เห็นนะ อิอิ..😝➠','แอบทำมัย? มาคุยกันหน่อย➠','แอบแฟนเล่นหราา💨➠','รู้นะว่าคัยอ่าน👉➠','เล่นซ่อนแอบหรอคร้าบบ👻➠','มาคุยกับเค้าหน่อย➠','นั่นแน่ แอบหราาา➠','จร๊ะ!!..เอ๋!..➠']
                            line.sendMessage(op.param1, str(random.choice(pref))+'เพิ่มเลียนแบบ '+Name)
                    else:
                        pass
                else:
                    pass
